...
export async function generateWordReportBlob(): Promise<Blob> {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'إنشاء البلاغات بسهولة: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'إمكانية إرسال طلب صيانة سريع مع تحديد الماكينة، نوع العطل، درجة الأولوية (منخفضة/متوسطة/عاجلة)، ووصف المشكلة وإرفاق الصور التوضيحية.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'التوجيه والإسناد الذكي: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'فرز وتوجيه البلاغ للفني المختص حسب عبء العمل والتخصص وتحديد الوقت التقديري للإصلاح.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'إدارة مسار الورش الخارجية: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'في حال تطلب العطل ورشة خارجية متخصصة، يتم إطلاق مسار اعتماد رسمي يبدأ من مدير الصيانة ثم موافقة الإدارة العامة مع توثيق التكاليف وفواتير الورشة.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'التتبع الفوري للحالات: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'حالات واضحة وشفافة (جديد ⬅️ مسند للفني ⬅️ قيد التنفيذ ⬅️ ورشة خارجية ⬅️ بانتظار الاعتماد ⬅️ مغلق ومكتمل).',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'التقييم وتأكيد الاستلام: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'بعد إتمام الصيانة، يؤكد صاحب الطلب استلام المعدة بحالة سليمة ويقيم جودة العمل المنجز بالنجوم مع كتابة ملاحظاته.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '🔹 ب. إدارة الأصول والمعدات (Asset Management):',
                font: 'Calibri',
                size: 24,
                bold: true,
                color: '2C5282'
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'سجل شامل للأصول: توثيق الماكينات، الأقسام المالكة، الأرقام التسلسلية، الموديلات، والتواريخ.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'ترميز وتصنيف الأصول: ترميز كل ماكينة برقم وكود فني فريد مع ربطها بنوع الجهاز والقسم والموقع الجغرافي داخل المنشأة.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'السجل التاريخي (History Log): معرفة كافة الأعطال السابقة لكل ماكينة وتكلفة صيانتها وقطع الغيار المستبدلة فيها.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '🔹 ج. إدارة المستودع وقطع الغيار (Inventory & Warehouse):',
                font: 'Calibri',
                size: 24,
                bold: true,
                color: '2C5282'
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'حصر الأصناف وأسعارها وتحديد حد إعادة الطلب (Min Stock Level).',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'الخصم الآلي للقطع: خصم قطع الغيار تلقائياً من رصيد المستودع بمجرد إرفاقها بطلب الصيانة.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'تنبيهات فورية عند اقتراب نفاد أي قطعة غيار لتفادي توقف العمل المفاجئ.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '🔹 د. مؤشرات الأداء والتقارير الذكية (Analytics & KPIs):',
                font: 'Calibri',
                size: 24,
                bold: true,
                color: '2C5282'
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'لوحة قيادة تفاعلية توضح سرعة الاستجابة، معدل الإنجاز، وإجمالي التكاليف.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'تصدير تقارير صيانة رسمية وطباعة أوامر العمل وبطاقات الاستلام بصيغة PDF و Word.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'يسير العمل في النظام ضمن 5 مراحل محكمة تضمن عدم ضياع أي طلب:',
                font: 'Calibri',
                size: 24
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '1. التبليغ والتسجيل: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'الموظف يكتشف الخلل ويرسل طلب الصيانة إلكترونياً بثوانٍ معدودة.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '2. المراجعة والإسناد: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'مدير الصيانة يعاين البلاغ، يحدد أولوية التدخل، ويسند المهمة للفني المختص.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '3. التنفيذ الفعلي: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'يستلم الفني الإشعار، يبدأ الإصلاح، يصرف قطع الغيار المطلوبة، ويوثق التقرير الفني عند الانتهاء.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '4. الورشة الخارجية (عند الحاجة): ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'تحويل الطلب للمسار الخارجي، موافقة المدير العام، ثم تسليم واستلام الأصل من الورشة.',
                font: 'Calibri',
                size: 22
              })
            ]
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '5. الاعتماد والتقييم: ',
                font: 'Calibri',
                size: 22,
                bold: true
              }),
              new TextRun({
                text: 'اعتماد مدير الصيانة لإغلاق الطلب، وتأكيد طالب الصيانة لاستلام الجهاز وتقييم الجودة.',
                font: 'Calibri',
                size: 22
              })
            ]
                  ...
                  new TableCell({
                    ...
                    children: [
                      new Paragraph({
                        ...
                        children: [
                          new TextRun({
                            text: 'الأثر التشغيلي والمالي المباشر',
                            font: 'Calibri',
                            size: 22,
                            bold: true,
                            color: 'FFFFFF'
...
export async function downloadWordReport(): Promise<void> {
  const blob = await generateWordReportBlob();
  saveAs(blob, 'تقرير_نظام_إدارة_الصيانة_والأصول_CMMS.docx');
}
